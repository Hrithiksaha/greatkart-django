        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exist:
                    ...
                    #Getting variation products based on cart id
                    ...
                    #Get the cart items from the user to access his production variations
...
def activate(request,uidb64,token):
    ...
    except(OverflowError,ValueError,TypeError,Account.DoesNotExist):
        user=None
